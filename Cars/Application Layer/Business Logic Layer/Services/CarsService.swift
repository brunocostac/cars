...
protocol CarsService: AnyObject {
    func getCars(with category: Category, completion: @escaping (Result<[Car], Error>) -> Void)
    func getCar(with id: Int, category: Category, completion: @escaping (Result<Car?, Error>) -> Void)
    func getURL(with category:Category) -> URL
}
...
class CarsServiceImplementation: CarsService {
    ...
    func getCars(with category: Category, completion: @escaping (Result<[Car], Error>) -> Void) {
        let url = self.getURL(with: category)
    ...
    func getCar(with id: Int, category carType: Category, completion: @escaping (Result<Car?, Error>) -> Void) {
